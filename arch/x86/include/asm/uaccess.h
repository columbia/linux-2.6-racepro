...
({								\
	...
	scribe_post_uaccess(&__pu_val, __ret_pu ? 0 : sizeof(*(ptr)), ptr, 0); \
	__ret_pu;						\
})
...
do {									\
	...
	scribe_post_uaccess(&__pu_val, size, ptr, 0);			\
} while (0)
...
do {									\
	...
	scribe_post_uaccess(&(x), size, ptr, SCRIBE_DATA_INPUT);	\
} while (0)
...
({								\
	...
	scribe_post_uaccess(&__pu_val, __pu_err ? 0 : size, __pu_ptr, 0); \
	__pu_err;						\
})
